...
$config['default']['mongo_hostbase'] = 'ds027908.mongolab.com:27908';
$config['default']['mongo_database'] = 'teksystemsample';
$config['default']['mongo_username'] = 'mongoadmin';
$config['default']['mongo_password'] = 'j1135#weep';
